...
#ifndef JM_SUDOKU_SOLVER_DLX_V2A_H
#define JM_SUDOKU_SOLVER_DLX_V2A_H
...
#define DLX_V2A_SEARCH_MODE     SEARCH_MODE_ONE_ANSWER

namespace jmSudoku {
namespace dlx {
namespace v2a {

static const size_t kSearchMode = DLX_V2A_SEARCH_MODE;
...
private:    
    ...
    mincol_list<3, TotalConditions + 1>    mincol_list_;
        ...
        for (size_t row = 0; row < Rows; row++) {
            ...
            for (size_t col = 0; col < Cols; col++) {
                ...
                if (val == '.') {
                    ...
                    this->insert(index + 2, row_idx, (int)(81 * 2 + col * 9 + number + 1));
                    size_t box_x_9 = tables.box_x_9[pos];
                    this->insert(index + 3, row_idx, (int)(81 * 3 + box_x_9 + number + 1));
...
#endif // JM_SUDOKU_SOLVER_DLX_V2A_H
